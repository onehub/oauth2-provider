class SongkickOauth2SchemaAddAuthorizationIndex < ActiveRecord::Migration
  ...
  def self.up
    remove_index :oauth2_authorizations, :name => 'oa2_client_id_access_token_hash'
  ...
  def self.down
    ...
    add_index :oauth2_authorizations, [:client_id, :access_token_hash], :name => 'oa2_client_id_access_token_hash'
  end
end
